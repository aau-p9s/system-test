...
tests:list[TestCase] = [
    ...
    Baseline("Quick-Baseline-3-10x10", size=size, period=600, workload_count=3),
    GroundTruth("Quick-GroundTruth-3-10x10", size=size, period=600, workload_count=3),
    StudyResult("Quick-StudyResult-3-10x10", size=size, period=600, workload_count=3),
