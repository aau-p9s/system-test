...
def make_test_triple(name: str, size: dict[str, int] = {"x": 10, "y": 10}, period: int = 86400, delay: int = 25, scale_up: float = .5, scale_down: float = .2, min_replicas: int = 1, max_replicas: int = 10, workload_count: int = 1) -> list[TestCase]:
    return [
